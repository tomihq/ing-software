...
El proveedor B contiene un mensaje "getFile" que recibe un nombre de un archivo y devuelve un RemoteFile, que expone a través de data el contenido del archivo.
